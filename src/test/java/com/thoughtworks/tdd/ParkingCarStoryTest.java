...
public class ParkingCarStoryTest {
    @Test
    ...
    ///经理停车··································
    @Test
    public void should_return_car_when_manager_park_car() throws NullPointerException,CarHasBeenParkedException, NullCarException, NoPositionException, FakeTicketException, UsedTicketException, NoTicketException {
        //given
        Manager manager = new Manager();
        Car car = new Car();
        //when
